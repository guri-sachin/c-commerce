...
app.post('/buyorder',(req, res) => {
    let data = {name:req.body.name,price:req.body.price,image_name:req.body.image,usname:req.body.fullname,qty:req.body.qty,total:req.body.total,discount:req.body.discount,orderno:req.body.orderno};
    console.log(data);
    let sql = "INSERT INTO acc SET ?";
    let query = conn.query(sql, data,(err, results) => {
        if(err)throw err;
