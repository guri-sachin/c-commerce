...
var data ={"fullname":fullname,"name":location.state[0].name,"qty":qty,"price":location.state[0].price,"disamount":disamount,"total":total,"disc":disc,"image":location.state[0].image_name.split(",")[0]}
...
<div class="ab51">Add Pincode to Get Delivery and Assembly Details</div>
<div class="ab40"></div>
<div class="row">
<div class="col-md-4">
