                ...
                <div class="col-md-8">
                  <div class="ab70">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-2"><div class="ab76 ab100" >Quantity</div></div>
                      <div class="col-md-2"><div class="ab76 ab100">Name</div></div>
                   
                      <div class="col-md-2"><div class="ab76 ab100" >Total</div></div>
                      <div class="col-md-2"><div class="ab76 ab100" >Status</div></div>
                    </div>
              ...
              return(
                  <tr key={index}>
                      ...
                      <td> {(item.split(","))} 
                            ...
                            <div class="col-md-2"><div class="ab37 ab100" >{JSON.parse(item.qty.split(",")).map((item, index) => {
                              return (
                                <tr key={index}>
                            ...
                            <div class="col-md-2"><div class="ab37 ab100" >{item.status}</div></div>
                          </tr>
                        );
                      })}
